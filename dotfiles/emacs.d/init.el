...
(add-to-list 'load-path "~/.emacs.d/lisp") ; to find Emacs 23 package.el
(require 'package)
(package-initialize)
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (## yaml-mode s pytest projectile jsx-mode jedi-direx elpy dockerfile-mode color-theme clang-format async))))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(font-lock-comment-face ((t (:background "black" :foreground "red")))))
